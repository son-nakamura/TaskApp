...
import android.support.v7.app.NotificationCompat;   // v7でもNotificationCompat.Builderが使える
...
public class TaskAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // 通知の設定を行う
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context);   // 動作する
